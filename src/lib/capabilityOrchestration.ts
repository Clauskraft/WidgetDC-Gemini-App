...
export const prototypeBuilderProviders: PrototypeBuilderProvider[] = [
  {
    ...
    toolboxUse:
      "Selects the provider route and records the proof boundary before any builder output is trusted.",
  ...
  },
  {
    ...
    toolboxUse:
      "Generate candidate UI, inspect preview, then export through PR/add-to-codebase before WDC import.",
    authState: "ready",
  ...
  },
  {
    ...
    toolboxUse:
      "Generate full-page variants, capture structure and routes, then treat output as candidate evidence.",
    ...
    handoffToWdc:
      "WDC CLI classifies output, maps capability coverage, and ports only selected patterns.",
  ...
  },
  {
    ...
    toolboxUse:
      "Review prototype quality and propose stronger interaction/visual patterns without becoming a gate.",
    authState: "login_required",
  ...
  },
  {
    ...
    toolboxUse:
      "Convert sketches/screens to design-system candidates and align logo, tokens, spacing, and motion.",
    authState: "login_required",
  ...
  },
  {
    ...
    toolboxUse:
      "Create preview deployments and fetch protected URLs, but only WDC readback can lift proof language.",
    authState: "token_required",
    allowedActions: ["preview deploy", "deployment logs", "protected URL fetch"],
    blockedActions: [
      "runtime-proof claim without WDC SHA/readback",
      "secret leakage",
    ...
    handoffToWdc:
      "Deployment refs feed WDC runtime/readback gates and EventSpine evidence bundles.",
    preferredWhen:
      "Need preview package, deploy diagnostics, or production deployment after explicit slice.",
  ...
  },
  {
    ...
    handoffToWdc:
      "RAG evidence shapes WorkBOM and provider scoring; it does not prove runtime behavior.",
    preferredWhen:
      "Need platform strategy, patterns, or prior evidence before selecting a builder.",
    fallbackTo: ["provider:wdc-cli"],
    boundary: "diagnostic",
  },
  {
    ...
    toolboxUse:
      "Reads visible prototype state and screenshots; never converts visuals into runtime proof.",
    authState: "ready",
    allowedActions: ["DOM readback", "screenshot", "visual diagnostic", "accessibility probe"],
    blockedActions: [
      "external side effect without approval",
      "proof promotion",
      "secret entry without explicit scope",
    ],
    evidenceRequirements: ["URL", "visible state", "screenshot", "blocked/actionable finding"],
    handoffToWdc:
      "Visual diagnostics become candidate evidence for WDC review and PR acceptance gates.",
